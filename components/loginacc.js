    ...
    render(){
        return(
            <ScrollView ref={this.scrollViewRef} style={{ display:!this.state.loading?'flex':'none', overflowX: 'none'}} 
                ...
                <View style={{height:Dimensions.get('window').height, backgroundColor: colors[this.context.mode].background}}>
                    <View style={{display:'flex', flexDirection:'row', alignItems:'center', justifyContent:'flex-start', marginTop:20}}>
                        <TouchableOpacity style={{marginLeft:10}} onPress={()=>{this.props.navigation.navigate('onboarding');}}>
                            <Image style={{width:24, height:24}} source={this.context.mode?require('./../assets/gameback-dark.png'):require('./../assets/gameback.png')} ></Image>
                        </TouchableOpacity>
                        <Text style={{fontFamily:'Chakra Petch SemiBold', fontSize:24, marginLeft:138, color:colors[this.context.mode].text1}}>Login</Text>
                    </View>
                    <View style={{width: Dimensions.get('window').width, flexDirection:'column', justifyContent:'flex-start', alignItems:'center', marginTop:40/*, borderWidth:1, borderLeftColor:'black'*/}}>
                        <Text style={{fontFamily:'Chakra Petch SemiBold', fontSize:22, textAlign:'left', width:378, color:colors[this.context.mode].text1}}>Welcome Back</Text>
                        <Text style={{fontFamily:'Chakra Petch SemiBold', fontSize:22, color:colors[this.context.mode].text2, textAlign:'left', width:378, marginBottom:10}}>Fill in your login details</Text>
                        <Text style={{fontFamily:'Chakra Petch Regular', width:378, fontSize:14, color:colors[this.context.mode].text2, marginTop:10}}>New to Pacplay? 
                            <TouchableOpacity onPress={()=>{this.props.navigation.navigate('createacc')}}><Text style={{color:colors[this.context.mode].text3, marginLeft:5}}>Create an account</Text></TouchableOpacity></Text>

                        <View style={{marginTop:20}}>
                            <Text style={{fontFamily:'Chakra Petch Regular', fontSize:16, color:colors[this.context.mode].inputlabel1}}>Username</Text>
                            <View style={{marginTop:10, flexDirection:'row', alignItems:'center', justifyContent:'space-between', width:378, flexWrap:'wrap'}}>
                                <TextInput
                                    ...
                                    style={{outlineStyle:'none', width:378, borderRadius:8, height:44, borderWidth:1, borderColor:colors[this.context.mode].inputborder1, fontSize:18, fontFamily:'Chakra Petch Regular', paddingLeft:15, paddingRight:15, color:colors[this.context.mode].text1}}
                                />
                            </View>
                        ...
                        <View style={{marginTop:20}}>
                            <Text style={{fontFamily:'Chakra Petch Regular', fontSize:16, color:colors[this.context.mode].inputlabel1}}>Password</Text>
                            <View style={{marginTop:10, flexDirection:'row', alignItems:'center', justifyContent:'space-between', width:378, flexWrap:'wrap', borderWidth:1, borderColor:colors[this.context.mode].inputborder1, borderRadius:8, paddingRight:15 }}>
                                <TextInput
                                    secureTextEntry={this.state.pass1toggle==='Hide Password'?false:true}
                                    placeholder={'Password'}
                                    value={ this.state.password }
                                    onChangeText={(e)=>{this.setState({password: e});}}
                                    style={{outlineStyle:'none', width:260, height:44, borderWidth:1, borderColor:'rgba(0,0,0,0)', fontSize:18, fontFamily:'Chakra Petch Regular', paddingLeft:15, paddingRight:15, color:colors[this.context.mode].text1}}
                                />
                        ...
                        <View style={{flexDirection:'row', alignItems:'center', justifyContent:'flex-end', width:378, marginTop:20}}>
                            ...
                            <Text style={{textAlign:'right', fontFamily:'Chakra Petch Regular', fontSize:14, color:colors[this.context.mode].text3}}>Forgot password?</Text>
                            </TouchableOpacity>
                        </View>
                        <Text style={{color:'red', fontFamily:'Chakra Petch Regular', fontSize:16, marginTop:35}}>{this.state.processwarning}</Text>


                        <TouchableOpacity style={{width:Dimensions.get('window').width-36, height:56, flexDirection:'row', alignItems:'center', justifyContent:'center', borderRadius:8, marginTop:90, backgroundColor:colors[this.context.mode].btn1}} onPress={()=>{this.loginaccount();}}>
                ...
                <View style={{width:Dimensions.get('window').width, height:Dimensions.get('window').height, flexDirection:'column', alignItems:'center', justifyContent:'flex-start', paddingTop:40, backgroundColor:colors[this.context.mode].background}}>
                    <Text style={{fontFamily:'Chakra Petch SemiBold', fontSize:20, width:Dimensions.get('window').width, textAlign:'center', color:colors[this.context.mode].text1}}>Confirm Email</Text>
                    <Text style={{fontFamily:'Chakra Petch Regular', fontSize:16, width:356, textAlign:'center', color:'', marginTop:10, color:colors[this.context.mode].text1}}>{'Input the 6 digit code that was sent to '+(this.state.changepassvars.email?this.state.changepassvars.email:'')+'. If it is not in your inbox check your spam.'}</Text>
                    <Text style={{fontFamily:'Chakra Petch Regular', fontSize:16, width:356, textAlign:'center', color:'', color:colors[this.context.mode].text1}}>The code will be invalid in 3 mins</Text>
                    <View style={{flexDirection:'row', justifyContent:'space-around', alignItems:'center', width:382}}>
                        <TextInput
                            ...
                            style={{outlineStyle:'none', width:60, height:50, fontSize:30, fontFamily:'Chakra Petch SemiBold', textAlign:'center', borderWidth:2, borderBottomColor:colors[this.context.mode].text1, borderTopColor:'rgba(0,0,0,0)', borderLeftColor:'rgba(0,0,0,0)', borderRightColor:'rgba(0,0,0,0)', color:colors[this.context.mode].text1}}
                        />
                    ...
                    <View style={{flexDirection:'column', alignItems:'center', justifyContent:'flex-start', marginTop:120}}>
                        <TouchableOpacity style={{width:Dimensions.get('window').width-36, height:56, flexDirection:'row', alignItems:'center', justifyContent:'center', borderRadius:8, marginTop:20, backgroundColor:colors[this.context.mode].btn1}} onPress={()=>{!this.state.vcodeloading?this.verifycode():'';}}>
                        ...
                        <TouchableOpacity style={{width:Dimensions.get('window').width-36, height:56, flexDirection:'row', alignItems:'center', justifyContent:'center', borderRadius:8, marginTop:20, backgroundColor:colors[this.context.mode].btn1}} onPress={()=>{this.goback();}}>
                ...
                <View style={{width:Dimensions.get('window').width, height:Dimensions.get('window').height, flexDirection:'column', alignItems:'center', justifyContent:'flex-start', paddingTop:40, backgroundColor:colors[this.context.mode].background}}>
                    <Text style={{fontFamily:'Chakra Petch SemiBold', fontSize:22, textAlign:'left', width:378, color:colors[this.context.mode].text1}}>Forgot Password</Text>

                    <View style={{marginTop:50}}>
                        <Text style={{fontFamily:'Chakra Petch Regular', fontSize:16, color:colors[this.context.mode].inputlabel1}}>Password</Text>
                        <View style={{marginTop:10, flexDirection:'row', alignItems:'center', justifyContent:'space-between', width:378, flexWrap:'wrap', borderWidth:1, borderColor:colors[this.context.mode].inputborder1, borderRadius:8, paddingRight:15, color:colors[this.context.mode].text1}}>
                            <TextInput
                                ...
                                style={{outlineStyle: 'none', width:260, borderRadius:8, height:44, borderWidth:1, borderColor:'rgba(0,0,0,0)', color:colors[this.context.mode].text1, fontSize:18, fontFamily:'Chakra Petch Regular', paddingLeft:15, paddingRight:15}}
                            />
                    ...
                    <View style={{marginTop:20}}>
                        <Text style={{fontFamily:'Chakra Petch Regular', fontSize:16, color:colors[this.context.mode].inputlabel1}}>Confirm Password</Text>
                        <View style={{marginTop:10, flexDirection:'row', alignItems:'center', justifyContent:'space-between', width:378, flexWrap:'wrap', borderWidth:1, borderColor:colors[this.context.mode].inputborder1, borderRadius:8, paddingRight:15}}>
                            <TextInput
                    ...
                    <TouchableOpacity style={{width:Dimensions.get('window').width-36, height:56, flexDirection:'row', alignItems:'center', justifyContent:'center', borderRadius:8, marginTop:90, backgroundColor:colors[this.context.mode].btn1}} onPress={()=>{!this.state.reqloading2?this.changepassword():'';}}>
